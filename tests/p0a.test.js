...
const {
  ...
  DEMO_OFFERS,
  DEMO_TARGET,
} = require('../backend/packages/shared')
const { validateAuthorization, validateOffer, validateRuntimeConfig } = require('../backend/packages/shared/validation')
const { getReplaySignal, getCardSignal } = require('../backend/packages/renaiss-client')
const { evaluateSignal, finalizeWithProof } = require('../backend/packages/policy-engine')
const {
  buildMarketProof,
  verifyMarketProof,
...
} = require('../backend/packages/market-proof')
